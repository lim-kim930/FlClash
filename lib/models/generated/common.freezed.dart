...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(trackerInfos),const DeepCollectionEquality().hash(keywords),query,autoScrollToEnd,sortType,sortDirection);
...
class _TrackerInfosState implements TrackerInfosState {
  const _TrackerInfosState({final  List<TrackerInfo> trackerInfos = const [], final  List<String> keywords = const [], this.query = '', this.autoScrollToEnd = true, this.sortType = ConnectionsSortType.none, this.sortDirection = SortDirection.desc}): _trackerInfos = trackerInfos,_keywords = keywords;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_trackerInfos),const DeepCollectionEquality().hash(_keywords),query,autoScrollToEnd,sortType,sortDirection);
